...
@Component({
  selector: 'app-forma-pantalla-por-menu',
  templateUrl: './forma-pantalla-por-menu.component.html',
  styleUrls: ['./forma-pantalla-por-menu.component.scss'],
})
export class FormaPantallaPorMenuComponent implements OnInit {
  forma: FormGroup;
  ...
  constructor(
    ...
    private ventana: MatDialogRef<FormaPantallaPorMenuComponent>,
